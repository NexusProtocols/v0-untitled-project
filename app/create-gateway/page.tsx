  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    img.onload = () => {
      if (img.width > 1920 || img.height > 1080) {
        setMessage({ type: "error", text: "Image dimensions must not exceed 1920x1080 pixels" })
        return
      }
      if (img.width < 500 || img.height < 500) {
        setMessage({ type: "error", text: "Image dimensions must be at least 500x500 pixels" })
        return
      }
            ...
            <div className="mb-4">
              ...
              <div className="mb-2">
                ...
                <label
                  ...
                  className="interactive-element flex cursor-pointer items-center justify-center rounded border border-dashed border-white/20 bg-[#000000] p-6 transition-all hover:border-[#ff3e3e]/50 hover:shadow-md hover:scale-[1.01] transform duration-200"
                >

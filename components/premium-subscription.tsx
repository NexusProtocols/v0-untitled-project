...
export function PremiumSubscription({ onPurchase, onSkip }: PremiumSubscriptionProps) {
  ...
  return (
    <div className="rounded-lg border-l-4 border-[#ff3e3e] bg-[#1a1a1a] p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="interactive-element rounded-lg border border-white/10 bg-[#050505] p-4 hover:bg-[#0a0a0a] transition-all hover:scale-105">
        ...
        <div className="interactive-element rounded-lg border-2 border-[#ff3e3e] bg-[#050505] p-4 hover:bg-[#0a0a0a] transition-all hover:scale-105 relative">
      ...
      <div className="text-center">
        ...
        >
          {countdown > 0 ? `Please wait (${countdown}s)` : "Continue with Ads"}
        </button>
      </div>
    </div>
  )
